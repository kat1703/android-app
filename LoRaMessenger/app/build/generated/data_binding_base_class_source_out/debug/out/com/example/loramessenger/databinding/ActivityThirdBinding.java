...
public final class ActivityThirdBinding implements ViewBinding {
  ...
  private ActivityThirdBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static ActivityThirdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityThirdBinding((ConstraintLayout) rootView, textView);
    }
