...
public final class ActivityFourthBinding implements ViewBinding {
  ...
  private ActivityFourthBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static ActivityFourthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFourthBinding((ConstraintLayout) rootView, textView);
    }
